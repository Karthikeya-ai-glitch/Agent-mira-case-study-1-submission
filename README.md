...
- Estimate house prices using the trained prediction model  
- Interact with the system through a clean, user-friendly interface  

![Application UI Preview](ui_preview.png)
